...
label scene2:
    ...
    Мистер Кей – это владелец двухэтажного дома, который я арендую.

    Я живу на 2-ом этаже, а на 1-ом этаже работает Мистер Кей. Он очень любит свою работу  и любит засиживаться в своём кабинете до последнего.

    Поэтому, иногда, когда я заигрываюсь с моим лучшим другом Ноем на наших музыкальных инструментах, то Мистер Кей всегда ворчит на нас.
    ...
    Я вам отвечу: Мистер Кей – часовщик.
    ...
    Но на самом деле Мистер Кей не ворчун и, если ему не действуют на нервы, то он очень даже добрый и отзывчивый старик.
